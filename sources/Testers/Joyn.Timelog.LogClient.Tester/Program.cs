    ...
    internal class Program
    {
        ...
        private static void RunApplication(int nMessages)
        {
            ...
            while (i < nMessages)
            {
                ...
                {
                    //Start operation
                    startMessage = Joyn.Timelog.Client.Logger.LogStart(Microsoft.Extensions.Logging.LogLevel.Trace,
                ...
                {
                    //Stop operation
                    Joyn.Timelog.Client.Logger.LogStop(startMessage, i);
                ...
                {
                    //Normal operation
                    Joyn.Timelog.Client.Logger.Log(Microsoft.Extensions.Logging.LogLevel.Trace,
                            validDomains[r.Next(0, validDomains.Length)],
                            validGuids[r.Next(0, validGuids.Length)], Guid.NewGuid(), i);
                }
        ...
        private static void RunApplication_OLD()
        {
            ...
            while (true)
            {
                ...
                Joyn.Timelog.Client.Logger.Log(Microsoft.Extensions.Logging.LogLevel.Trace, TimelogDomains.AssetGatewayDokRouter, Guid.NewGuid(), null);
