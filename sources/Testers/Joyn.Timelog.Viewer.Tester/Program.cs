...
builder.ConfigureServices((hostContext, services) =>
{
    ...
    services.AddHostedService<Joyn.Timelog.Viewer.ReportingClient>();
});
...
Joyn.Timelog.Viewer.ReportingClient.Startup(applicationKey, reportingClientConfiguration, logger, HelperViewer.OnLogMessagesReceived);
...
do
{
    ...
    else if (readConsole == "start")
    {
        ...
        Joyn.Timelog.Viewer.ReportingClient.SetFilter(new List<FilterCriteria>() { currentFilter });
    ...
    else if (readConsole == "file")
    {
        ...
        Joyn.Timelog.Viewer.ReportingClient.SetFilter(filters);
    }
...
static class HelperViewer
{
    ...
    {
        Joyn.Timelog.Viewer.ReportingClient.GetFilter();
    }
